  ...
  return (
    <div className=" bg-white">
      ...
      <section className="relative w-full h-[280px] md:h-[300px] lg:h-[300px] bg-gray-900 overflow-hidden">
        {/* Background Image */}
        <Image
          src="https://images.unsplash.com/photo-1665789318391-6057c533005e?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1332"
