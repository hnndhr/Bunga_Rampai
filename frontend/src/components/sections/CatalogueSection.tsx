        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            <p className="text-gray-300 leading-relaxed">
              Bunga Rampai adalah website yang merangkum berbagai hasil riset
              dan survei dari Kementerian Riset dan Data selama satu periode
              kepengurusan. Melalui platform ini, kami ingin menghadirkan data
              dan temuan riset dengan cara yang lebih terbuka, mudah diakses,
              dan relevan bagi siapa pun yang ingin mengenal lebih jauh hasil
              kerja kami.
            </p>
            <p className="text-gray-300 leading-relaxed">
              Semua informasi disajikan dalam bentuk infografis yang menarik dan
              informatif, agar pembaca bisa memahami isi data dengan cepat tanpa
              harus membaca laporan panjang. Dengan pendekatan visual ini, Bunga
              Rampai diharapkan menjadi ruang yang tidak hanya membagikan hasil
              penelitian, tapi juga menumbuhkan rasa ingin tahu dan apresiasi
              terhadap data dan riset itu sendiri.
            </p>
          </div>
